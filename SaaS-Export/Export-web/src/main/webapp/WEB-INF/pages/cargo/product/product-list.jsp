                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        ...
                        <%--<input type="text" class="form-control" placeholder="货号" name="productNo" value="${contractProduct.productNo}">--%>
                            <select class="form-control" name="productNo" onchange="change(value)">
                                <option value="" >请选择</option>
                    ...
                    <div class="col-md-4 data  rowHeight2x">
                        <textarea id="loadingRate" class="form-control" rows="3" placeholder="货物描述" name="productDesc">${contractProduct.productDesc}</textarea>
                    </div>
...
<script type="text/javascript">
    function change(value) {
        $.get(
            "${pageContext.request.contextPath}/cargo/contractProduct/findById.do?productNo="+value,
            function (data) {
                document.getElementById("loadingRate").value = data;
            },
            "text"
        );
