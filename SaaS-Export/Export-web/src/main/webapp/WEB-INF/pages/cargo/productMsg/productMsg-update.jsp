...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/cargo/productMsg/edit.do" method="post">
                <div class="row data-type" style="margin: 0px">
                    <div class="col-md-2 title">货号</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="货号" name="productNo" value="${page.productNo}">
                    </div>
                    <div class="col-md-2 title rowHeight2x">货物详情</div>
                    <div class="col-md-10 data rowHeight2x">
                        <textarea class="form-control" rows="3" name="loadingRate">${page.loadingRate}</textarea>
                    </div>
                </div>
          </form>
        </div>
