            ...
            <form id="editForm" action="${ctx}/cargo/extCproduct/edit.do" method="post" >
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data  rowHeight2x">
                        <textarea id="productDesc" class="form-control" rows="3" placeholder="货物描述" name="productDesc">${extCproduct.productDesc}</textarea>
                    </div>
...
<script type="text/javascript">
    function change(value) {
        $.get(
            "${pageContext.request.contextPath}/cargo/extCproduct/findById.do?productNo="+value,
            function (data) {
                document.getElementById("productDesc").value = data;
            },
            "text"
        );
    }
